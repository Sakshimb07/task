  ...
  return (
    <div className="flex min-h-screen text-[#374151] text-base font-inter bg-gray-100" style={{ display: "flex", minHeight: "100vh", color: "#374151", fontSize: "16px", fontFamily: "Inter, sans-serif", backgroundColor: "#f3f4f6" }}>
      ...
      <main className="flex-1 flex flex-col">
        ...
        {/* Summary Cards */}
        <section className="px-8 overflow-x-auto" style={{ overflowX: "auto" ,marginTop: "10px" }}>
          <div className="flex flex-row flex-nowrap space-x-6 min-w-max px-6" style={{ overflowX: "auto" , display: "flex", flexDirection: "row", flexWrap: "nowrap", gap: "24px", minWidth: "max-content", padding: "24px" }}>
            <Link to="/team/members" className="text-white p-6 rounded-xl shadow-lg min-w-[250px] bg-[#aac4e5]" style={{ minWidth: "200px", padding: "24px", borderRadius: "16px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", backgroundColor: "#aac4e5", height: "100px", textDecoration: "none" }}>
        ...
        {/* Activity Feed */}
        <section className="p-8 text-xs text-[#374151] font-inter flex flex-col gap-2" style={{ padding: "20px", marginTop: "20px", display: "flex", flexDirection: "column", gap: "3px" }}>
